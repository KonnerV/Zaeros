...
ld -m elf_i386 -T linker.ld -o krnl.bin kernel_entry.o io.o keyboard_asm.o idtasm.o idtc.o keyboard.o cpu.o kernel.o vga_write.o string.o pc_spkr.o -z noexecstack
